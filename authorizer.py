...
def lambda_handler(event, context):
    ...
    This function must genrate a policy that is associated with the recognized
                ...
                "Statement": [
                    {
                        ...
                        "Effect": "Allow",
                        "Resource": [
                            "arn:aws:execute-api:us-west-2:851075464416:zl5r1fjaxf/*/*/*"
                        ],
                    }
                ],
            },
            "context": {"key": "value", "number": 1, "bool": True},
        }
        # return fake_policy
        return policy
...
p = lambda_handler(
    {
        ...
        "methodArn": "arn:aws:execute-api:us-west-2:851075464416:zl5r1fjaxf/*/*/*",
    },
    {},
)
